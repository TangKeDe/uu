...
<form name = "form_change_user" action="${pageContext.request.contextPath}/login/PersonServlet?action=teaChange" method="post" onsubmit="document.charset='utf-8'">
...
<table align="center">
   ...
   <table border="2" bordercolor="darkblue" rules="none" width="95%" height="500" cellspacing="0" cellpadding="0" style="margin-top:30px" >
       <%  int num = (int) session.getAttribute("change_num");
           UserBean userBean = (UserBean) ((List)session.getAttribute("teacher_List")).get(num);
       %>
       <tr>
           <td align="left" style="margin-left: 20px"><br>&nbsp&nbsp&nbsp&nbsp工号原内容为：</td>
       ...
       <tr>
           <td align="left" style="margin-left: 20px">&nbsp&nbsp&nbsp&nbsp教学科目原内容为：</td>
           <td style="text-indent:30px"><%=userBean.getuser_tea()%></td>
       </tr>
       <tr>
           <td align="left" style="margin-left: 20px">&nbsp&nbsp&nbsp&nbsp您希望修改为：</td>
       ...
       <tr>
           <td align="left" style="margin-left: 20px">&nbsp&nbsp&nbsp&nbsp入职年份原内容为：</td>
           <td style="text-indent:30px"><%=userBean.getuser_data()%></td>
       </tr>
       <tr>
           <td align="left" style="margin-left: 20px">&nbsp&nbsp&nbsp&nbsp您希望修改为：</td>
