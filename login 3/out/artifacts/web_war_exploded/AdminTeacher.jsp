...
<main class="page-content">
    <div class="col-sm-4 text-center" style="margin-left: 210px">
        <div>
            <a href="AdminTeaAdd.jsp"> <img src="img/tianjia.png" alt=""></a>
        </div>
        <p>添加</p>
    </div>
    ...
    <div class="center" >
        ...
        <table id="sample2" width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <th>序号</th><th>工号</th><th>姓名</th><th>所教科目</th><th>入职年份</th><th>账户密码</th><th>操作</th>

            </tr>
            <form name = "form_change_user" action="${pageContext.request.contextPath}/login/PersonServlet" method="post">
                <Script>
                    function get_User(string)
                    {
                        document.form_change_user.action="${pageContext.request.contextPath}/login/PersonServlet?action=tea" + string;
                        document.form_change_user.submit();
                    }
                    function delete_User(string)
                    {
                        document.form_change_user.action="${pageContext.request.contextPath}/login/PersonServlet?action=delete_tea" + string;
                        document.form_change_user.submit();
                    }
                </Script>
                <% List<UserBean> userBeanList = (List<UserBean>)session.getAttribute("teacher_List");
                ...
                <tr>
                    ...
                    <td align="center"><%=userBean.getuser_tea()%></td>
                    <td align="center"><%=userBean.getuser_data()%></td>
