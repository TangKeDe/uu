        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <%--<li><a href="teaPCscore.jsp"><i class="fa fa-bar-chart-o"></i><span>查看成绩</span></a></li>--%>
        ...
        <table align="center">
            <tr>
                <td width="548" align="center" valign="top">
                    <%--     <c:set var="friendBean" value="${requestScope.friendSingle}"></c:set>
                         <c:if test="${friendBean==null}">
                         查看个人资料失败！
                         </c:if>
                         <c:if test="${friendBean!=null}">
     --%>
                    <table border="2" bordercolor="darkblue" rules="none" width="95%" height="300" cellspacing="0" cellpadding="0" style="margin-top:30" >
                        <%
                            UserBean userBean1=(UserBean) session.getAttribute("loginer");
                            if(userBean1==null){
                        %>查看个人资料失败！<% }else{
                    %>
                        <tr>
                            <td width="30%" style="margin-left: 20px">姓名：</td>
                            <td style="text-indent:30px"><%=userBean1.getname() %></td>
                        </tr>
                        <tr>
                            <td align="left" style="margin-left: 20px">工号：</td>
                            <td style="text-indent:30px"><%=userBean1.getuser_name() %></td>
                        </tr>
                        <tr>
                            <td align="left" style="margin-left: 20px">教学科目：</td>
                            <td style="text-indent:30px"><%=userBean1.getuser_tea()%></td>
                        </tr>
                        <% } %>
                    </table>
                </td>
